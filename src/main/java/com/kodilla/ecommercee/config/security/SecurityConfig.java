...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic()
                ...
                .antMatchers(HttpMethod.POST, "/v1/user", "/v1/cart/*", "/v1/cart*").permitAll()
                .antMatchers(HttpMethod.PUT, "/v1/user", "/v1/cart/*", "/v1/cart*").permitAll()
                .antMatchers(HttpMethod.POST, "/v1/group", "/v1/order", "/v1/product*").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/v1/group", "/v1/order", "/v1/product*").hasRole("ADMIN")
